...
Icons in **spellicons** folder and its subfolders are for spell/ability icons and for the modifier icons (Modifiers are buffs/debuffs that abilities or items apply).
...
It is desirable for icons in **spellicons** and its subfolders to not have pips/dots in the corner but it is not a big issue if they do have pips/dots.
