...
OAAOptions = Components:Register('OAAOptions', COMPONENT_TEAM_SELECT)
...
function OAAOptions:Init ()
  ...
  CustomNetTables:SetTableValue("oaa_settings", "default", self.settings)
...
function OAAOptions:AdjustGameMode()
  ...
  CustomNetTables:SetTableValue("oaa_settings", "locked", self.settings)
