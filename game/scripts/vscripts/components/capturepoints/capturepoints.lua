...
function CapturePoints:ActuallyStartCapture()
  ...
  local radiant_capture_point = CreateUnitByName("npc_dota_thinker", leftVector, false, nil, nil, DOTA_TEAM_SPECTATOR)
  ...
  local dire_capture_point = CreateUnitByName("npc_dota_thinker", rightVector, false, nil, nil, DOTA_TEAM_SPECTATOR)
