...
function Sparks:FindDefaultSparkForHero(hero)
  ...
  local default_sparks = {
    ...
    npc_dota_hero_bloodseeker = "power", -- cleave
    ...
    npc_dota_hero_death_prophet = "cleave",
    npc_dota_hero_disruptor = "midas",
    npc_dota_hero_doom_bringer = "power", -- midas
    npc_dota_hero_dragon_knight = "power",
    ...
    npc_dota_hero_morphling = "cleave", -- cleave or power
    ...
    npc_dota_hero_phantom_assassin = "cleave", -- cleave or power
    npc_dota_hero_phantom_lancer = "power",
    npc_dota_hero_phoenix = "midas",
    npc_dota_hero_primal_beast = "power",
    npc_dota_hero_puck = "cleave",
    npc_dota_hero_pudge = "power",
    ...
    npc_dota_hero_shredder = "power", -- midas
    npc_dota_hero_silencer = "cleave",
