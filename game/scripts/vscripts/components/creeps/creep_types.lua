...
CreepTypes = {
  -- 1 "easy camp"
  {
    {                                              --HP   MANA  DMG   ARM   GOLD  EXP
      {"npc_dota_neutral_kobold",                   280,    0,  10,   0.5,   16,  80}, --expected gold is  46 and XP is 240
      {"npc_dota_neutral_kobold_tunneler",          480,    0,  12,    1,    25, 130}
    },
    {
      {"npc_dota_neutral_kobold_taskmaster",        560,    0,  16,    1,    27, 150},
      {"npc_dota_neutral_kobold",                   280,    0,  10,   0.5,   16,  80}
    },
    {
      {"npc_dota_neutral_kobold",                   280,    0,  10,   0.5,   16,  80},
      {"npc_dota_neutral_kobold_tunneler",          480,    0,  12,    1,    25, 130}
    ...
    -- 3 "hard camp"
  {
    ...
    {
      {"npc_dota_neutral_giant_wolf",            640, 160,   24,   3,    36,    90},
      {"npc_dota_neutral_giant_wolf",            640, 160,   24,   3,    36,    90},
      {"npc_dota_neutral_alpha_wolf",           1200, 480,   56,   5,   120,   120}
    },
    {
      {"npc_dota_neutral_giant_wolf",            640, 160,   24,   3,    36,    90},
      {"npc_dota_neutral_alpha_wolf",           1200, 480,   56,   5,   120,   120}
