...
function CreepPower:GetBasePowerForMinute (minute, multFactor)
  ...
  return {
    minute,                                   -- minute
    (55 * ((minute / 100) ^ 4) - 45 * ((minute/100) ^ 3) + 25 * ((minute/100) ^ 2) + 5 * (minute/100)) + 1,   -- hp
    (55 * ((minute / 100) ^ 4) - 45 * ((minute/100) ^ 3) + 25 * ((minute/100) ^ 2) + 5 * (minute/100)) + 1,   -- mana
    (220 * ((minute / 100) ^ 4) - 180 * ((minute/100) ^ 3) + 100 * ((minute/100) ^ 2) + 20 * (minute/100)) + 1,     -- damage
    (minute / 24) ^ 2 + minute / 6 + 1,       -- armor
