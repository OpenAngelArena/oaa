...
function CreepPower:GetPowerForMinute (minute)
  ...
  return {
    minute,                                   -- minute
    (7.5 * ((minute / 100) ^ 4) + 15 * ((minute/100) ^ 3) - 0.45 * ((minute/100) ^ 2) + 0.30 * (minute/100)) + 1,   -- hp
    (7.5 * ((minute / 100) ^ 4) + 15 * ((minute/100) ^ 3) - 0.45 * ((minute/100) ^ 2) + 0.3 * (minute/100)) + 1,   -- mana
    (40 * ((minute / 100) ^ 4) + 80 * ((minute/100) ^ 3) - 2.4 * ((minute/100) ^ 2) + 1.6 * (minute/100)) + 1,     -- damage
    (minute / 20) ^ 2 + minute / 7 + 1,       -- armor
    (minute / 2) + 1,                         -- gold
