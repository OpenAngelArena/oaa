...
function ProtectionAura:Init ()
  ...
  self.IsValidMap = GetMapName() == "oaa_seasonal" or GetMapName() == "oaa_alternate" or GetMapName() == "1v1" or legacy or GetMapName() == "10v10" or GetMapName() == "oaa_bigmode" or GetMapName() == "tinymode"
