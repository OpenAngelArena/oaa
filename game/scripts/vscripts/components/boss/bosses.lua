Bosses = {
  -- tier 1
  {
    ...
    {
      "npc_dota_boss_stopfightingyourself_t5",
      "npc_dota_boss_twin_t5",
      "npc_dota_boss_shielder_t5",
      "npc_dota_creature_ogre_tank_boss_t5"
    },
  },
  -- tier 1
  {
    ...
    },
    {
      ...
      "npc_dota_creature_temple_guardian_spawner_t5",
      "npc_dota_boss_stopfightingyourself"
    },
    {
      "npc_dota_boss_twin_t5",
      "npc_dota_boss_shielder_t5",
      "npc_dota_creature_lycan_boss_t5",
      "npc_dota_boss_charger_t5",
      "npc_dota_creature_ogre_tank_boss_t5",
      "npc_dota_creature_spider_boss_t5",
      "npc_dota_boss_stopfightingyourself_t5",
      "npc_dota_creature_temple_guardian_spawner_t5"
    },
  },
