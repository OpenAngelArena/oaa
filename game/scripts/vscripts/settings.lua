...
-- Formula for XP on hero kill: (HERO_XP_BOUNTY_BASE + AOE_XP_BONUS_FACTOR x DyingHeroXP)/number_of_killers
-- Old formula: DyingHeroBaseXPBounty + (AOE_XP_LEVEL_MULTIPLIER × DyingHeroLevel) + (AOE_XP_BONUS_FACTOR × TeamXPDiff × DyingHeroXP)
HERO_XP_BOUNTY_BASE = 40
AOE_XP_BONUS_FACTOR = 0.14
HERO_KILL_XP_RADIUS = 1500
