  ...
  if not bInterrupted then
    if IsServer() then
      ...
      if self.iAutomatonCount < self:GetSpecialValueFor("unit_limit") then
        ...
        local iParticle = ParticleManager:CreateParticle(sParticleName, PATTACH_ABSORIGIN_FOLLOW, hUnit)
