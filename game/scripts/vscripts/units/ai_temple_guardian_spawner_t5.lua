...
function TempleGuardianSpawnerThink()
  ...
  thisEntity.bossHandle1 = CreateUnitByName('npc_dota_creature_temple_guardian_t5', thisEntity:GetAbsOrigin() +  Vector( 300, 0, 0 ), true, nil, nil, DOTA_TEAM_NEUTRALS)
  thisEntity.bossHandle2 = CreateUnitByName('npc_dota_creature_temple_guardian_t5', thisEntity:GetAbsOrigin() -  Vector( 300, 0, 0 ), true, nil, nil, DOTA_TEAM_NEUTRALS)
