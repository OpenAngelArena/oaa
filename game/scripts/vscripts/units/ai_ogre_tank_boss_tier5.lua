LinkLuaModifier("ogre_tank_boss_jump_smash_tier5", "abilities/siltbreaker/npc_dota_creature_ogre_tank_boss/ogre_tank_boss_jump_smash_tier5.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("ogre_tank_boss_melee_smash_tier5", "abilities/siltbreaker/npc_dota_creature_ogre_tank_boss/ogre_tank_boss_melee_smash_tier5.lua", LUA_MODIFIER_MOTION_NONE)
